...
import EventSidebar, { SidebarNavKey } from "../components/game/GameSideBar";
import { CoreCategoryKey } from "../components/game/typs";
import { CORE_CATEGORIES, EU_COUNTRIES, SAMPLE_EVENTS } from "../components/game/data";
import MainContentFeed from "../components/game/GameFeed";
...
export default function GamePage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white">
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-56 bg-gradient-to-b from-fuchsia-900/60 via-neutral-950 to-neutral-950" />
