//app/components/society/LastYearEvent.tsx
"use client";
...
export default function LastYearEvent({
  title = "Throwback in 2025 Events",
      ...
      <div className="flex items-end justify-between gap-4 mb-4">
        <div>
          ...
          <p className="text-sm text-slate-600">
            Explore Thai temples and community event 2025.
          </p>
        </div>
