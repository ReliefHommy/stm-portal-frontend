    ...
    Explore Food Partner Program
        ...
        <section className="space-y-4 rounded-2xl bg-white p-6 shadow-sm md:p-8">
          ...
          <div className="pt-2">
            ...
            <Link
              href="https://admin.somtammarket.com/"
              className="inline-flex items-center justify-center rounded-full bg-indigo-700 px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-700"
            >
        ...
        {/* Global CTA Section */}
        <section className="rounded-2xl bg-indigo-800 p-6 text-white shadow-md md:p-8">
          ...
          <div className="mt-6">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-semibold text-indigo-700 shadow-sm transition hover:bg-emerald-50"
            >
